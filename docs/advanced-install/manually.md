...
Want a specific version? Swap `latest/download` for `download/<tag>` (say `download/v0.3.0`). See [all releases](https://github.com/tfindley/syscert/releases).
...
Next: [Configuration](/docs/configuration/) · [Compile from source](/docs/advanced-install/compile-from-source/) · [As a cron job](/docs/advanced-install/cron/)
